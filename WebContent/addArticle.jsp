...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="addPassage" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">撰写新文章</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">标题</label>
              标题：<input type="text" id="article-title" name="title" class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off">
            </div>
            <div class="form-group">
              <label for="article-title" class="sr-only">作者</label>
           作者：   <input type="text" id="article-title" name="author" class="form-control" required autofocus autocomplete="off">
            </div>
           
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
             <!--  <script id="article-content" name="passage.content" type="text/plain"></script> -->
               内&nbsp;&nbsp;容：<textarea rows="10" cols="105" placeholder="请在此处输入博文内容" id="article-content" name="content" class="form-control">
             ...
             <div class="form-group">
              <label for="article-title" class="sr-only">所属类型</label>
              文章类型：
                    <select class="form-control" name="tid">
                    
                       <option value="" selected="selected" >--选择文章类别(若没有所属类型，请先选择增加新类型)--</option>
                        <c:forEach var="tt" items="${tlist1 }">
                         
                             <option value="${tt.id}">${tt.name }</option>
                        </c:forEach>
                 </select> 
                    <input type="submit" class="btn btn-info" value="添加新文章">
           ...
           <!--  <div class="add-article-box">
            ...
            <!-- <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="cdate" autocomplete="off"></textarea>
