  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="getMessage">留言</a></li>
      ...
      <form action="/Comment/checkAll" method="post">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
            <c:forEach var="ms" items="${msglist }">
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="" /></td>
                <td class="article-title">${ms.uid }</td>
                <td>${ms.time }</td>
                 <td>${ms.content }</td>
                <td>
                 <!--  <a rel="1" name="see">查看</a>  -->
                  <!-- <a rel="1" name="delete">删除</a> -->
                   <a href="getBymsid?id=${ms.id }">查看</a> 
                  <a href="javascript:if(confirm('确实要将此条留言删除吗?'))location='delMessage?id=${ms.id}'">删除</a>
                </td>
              </tr>
              </c:forEach>
            </tbody>
