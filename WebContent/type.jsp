    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <form action="addType" method="post" autocomplete="off">
              ...
              <tbody>
                <c:forEach var="tt" items="${ttlist}">
                   <tr>
                       <td>${tt.id }</td>
                       <td>${tt.name }</td>
                      <%--  <td>${tt.num }</td> --%><!-- 某种类型的文章总数 -->
                       <td>
                           <a href="updateType.jsp">修改</a>
                           <a href="javascript:if(confirm('确实要删除吗?'))location='deleteType?id=${tt.id}'">删除</a>
                       </td>
                   </tr>
                </c:forEach>
              </tbody>
