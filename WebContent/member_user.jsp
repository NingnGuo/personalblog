    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <form action="getByKeyword" method="post" class="navbar-form navbar-right" role="search">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
        <li><a href="adminIndex.jsp">报告</a></li>
      </ul>
      <ul class="nav nav-sidebar">
        <li><a href="getAllPassage">文章</a></li>
        <li><a href="notice.jsp">公告</a></li>
        <li><a href="getMessage">留言</a></li>
       <!--  <li><a data-toggle="tooltip" data-placement="top" title="网站暂无留言功能">留言</a></li> -->
      </ul>
      <ul class="nav nav-sidebar">
        <li><a href="getAllType">类型</a></li>
    ...
    <h1 class="page-header">操作</h1>
        ...
        <h1 class="page-header">管理 <span class="badge">8</span></h1>
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                <th><span class="glyphicon glyphicon-th-large"></span> <span class="visible-lg">ID</span></th>
                <th><span class="glyphicon glyphicon-user"></span> <span class="visible-lg">用户头像</span></th>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              <tr>
                <td wdith="20%">用户名:</td>
                <td width="80%"><input type="text" value="" class="form-control" name="username" maxlength="10" autocomplete="off" id="addname"/></td>
              </tr>
              
              <tr>
                <td wdith="20%">密码:</td>
                <td width="80%"><input type="password" class="form-control" name="password" maxlength="18" autocomplete="off" id="addpwd"/></td>
              </tr>
              <tr>
                <td wdith="20%">确认密码:</td>
                <td width="80%"><input type="password" class="form-control" name="new_password" maxlength="18" autocomplete="off" id="addrpwd"/></td>
              </tr>
             <tr>
                <td wdith="20%">选择头像</label>
                <td width="80%"><input type="file" id="addtouxiang" class="file"></td>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">密码:</td>
                <td width="80%"><input type="password" class="form-control" name="updatepwd" maxlength="18" autocomplete="off" /></td>
              </tr>
             <tr>
...
$("#addUserBtn").click(function(){
	...
	if(pwd!=rpwd){
        ...
        if($('#addtouxiang')[0].files[0]!=null){
        	formData.append('touxiang', $('#addtouxiang')[0].files[0]);
        }

        formData.append('username',name);
        formData.append('pwd',rpwd);
    	...
    	if(data!=null){
    		...
    		$(data).each(function(i){
    			 ...
    			 $("#userList").append('<tr>'
                       ...
                       +'<td>'+data[i].id+'</td>'
                       +'<td width="80"><img src="'+data[i].touxiang+'" width="100" height="100">'
                       +'</td>'
                       ...
                       +' <a title="编辑" id="updateA">'
                       +'<input type="hidden" class="idText" value="'+data[i].id+'">'
                       +'  编辑'
                       +' </a>'
                     
                       +'  <a title="删除" id="delete">'
                       +'<input type="hidden" class="idText" value="'+data[i].id+'">'
                       +'  删除'
                       +'  </a>'
                       +' </td>'
...
$('#userList').on('click', "#updateA", function(){
	
	var userid=$(this).find(".idText").val();
