...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="updatePassage" method="post" class="add-article-form">
        <input type="hidden" name="id" value="${p.id }">
          <div class="col-md-9">
            <h1 class="page-header">文章修改</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">标题</label>
              <input type="text" id="article-title" name="title" class="form-control" placeholder="这里是文章的标题" value="${p.title }" required autofocus autocomplete="off">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">作者</label>
              <script id="article-content"  type="text/plain" name="author">${p.author}</script>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>所属类型</span></h2>
              <div class="add-article-box-content">
              	<%-- <input type="text" class="form-control" value="${p.type.name }" name="tid" autocomplete="off"> --%>
              	 <select class="form-control" name="tid">
                     <%--  <option value="${p.type.name }" selected="selected" ></option> --%> 
                        <c:forEach var="tt" items="${tlist }">
                     <option value="${p.type.name }" selected="selected" ></option>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="content" autocomplete="off" id="textarea">${p.content}</textarea>
                <span class="prompt-text">宁静致远个人博客</span>
              </div>
            </div>
